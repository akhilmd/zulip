...
def update_display_settings_backend(request, user_profile,
                                    ...
                                    disable_wrong_narrow_warning=REQ(validator=check_bool, default=None),
                                    emojiset=REQ(validator=check_string, default=None),
                                    timezone=REQ(validator=check_string, default=None)):
    # type: (HttpRequest, UserProfile, Optional[bool], Optional[str], Optional[bool], Optional[bool], Optional[bool], Optional[Text], Optional[Text]) -> HttpResponse
